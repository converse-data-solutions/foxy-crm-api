export function subscriptionReminderTemplate(userName: string, endDate: Date): string {
  ...
  return `
<div style="font-family: Arial, sans-serif; border: 1px solid #ffeeba; padding: 20px; max-width: 600px; margin: auto; background-color: #fff3cd; color: #856404; border-radius: 8px;">
  <p>Dear ${userName},</p>
  
  <p>This is a friendly reminder that your <strong>subscription is going to end soon</strong>.</p>

  <div style="background: #fff; border: 1px solid #ffeeba; padding: 15px; margin: 15px 0; border-radius: 6px;">
  ...
  <p><a href="mailto:support@conversedatasolutions.com" style="color: #856404; text-decoration: underline;">support@conversedatasolutions.com</a></p>
</div>
  `;
}
