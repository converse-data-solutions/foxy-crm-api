...
export class Baseapp1761117883247 implements MigrationInterface {
  name = 'Baseapp1761117883247';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "plans" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "plan_name" character varying(20) NOT NULL, "user_count" "public"."plans_user_count_enum" NOT NULL, CONSTRAINT "PK_3720521a81c7c24fe9b7202ba61" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "subscription_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "razorpay_payment_id" character varying(100), "razorpay_subscription_id" character varying(50), "razorpay_customer_id" character varying(50), "status" boolean NOT NULL DEFAULT false, "start_date" TIMESTAMP, "end_date" TIMESTAMP, "amount" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "tenant_id" uuid, "plan_price_id" uuid, CONSTRAINT "PK_91a0ee8b462f23bfb2ad7924754" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."plan_pricings_billing_cycle_enum" AS ENUM('monthly', 'quarterly', 'halfyearly', 'yearly')`,
    );
    await queryRunner.query(
      `CREATE TABLE "plan_pricings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "billing_cycle" "public"."plan_pricings_billing_cycle_enum" NOT NULL, "price" integer NOT NULL, "price_id" character varying(100), "plan_id" uuid, CONSTRAINT "PK_27d7c146112678a013f2e861d38" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "subscriptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" boolean NOT NULL DEFAULT false, "start_date" TIMESTAMP, "end_date" TIMESTAMP, "razorpay_payment_id" character varying(100), "razorpay_subscription_id" character varying(50), "razorpay_customer_id" character varying(50), "tenant_id" uuid, "plan_price_id" uuid, CONSTRAINT "REL_f6ac03431c311ccb8bbd7d3af1" UNIQUE ("tenant_id"), CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
