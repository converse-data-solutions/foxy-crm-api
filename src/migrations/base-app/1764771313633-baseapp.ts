...
export class Baseapp1764771313633 implements MigrationInterface {
  name = 'Baseapp1764771313633';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "plans" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "plan_name" character varying(20) NOT NULL, "stripe_product_id" character varying(100), "user_count" "public"."plans_user_count_enum" NOT NULL, "api_calls_per_minute" integer NOT NULL DEFAULT '50', CONSTRAINT "PK_3720521a81c7c24fe9b7202ba61" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('subscription_upgraded', 'subscription_downgraded', 'subscription_renewed', 'role_changed', 'schema_created', 'subscribed', 'payment_failed')`,
    );
    await queryRunner.query(
      `CREATE TABLE "audit_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "action" "public"."audit_logs_action_enum" NOT NULL, "tenant_id" character varying(50) NOT NULL, "user_id" character varying(50) NOT NULL, "ip_address" character varying(40), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1bb179d048bbc581caa3b013439" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
