...
export class Coreapp1764767644812 implements MigrationInterface {
  name = 'Coreapp1764767644812';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "lead_activities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "activity_type" "lead_activities_activity_type_enum" NOT NULL, "activity_date" TIMESTAMP NOT NULL DEFAULT now(), "note_id" character varying(40), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "lead_id" uuid, "created_by" uuid, CONSTRAINT "PK_1aa1cc6988a817368568ca26bf1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_5c37aa54e3b06f6733d56007e0" ON "leads" ("assigned_to") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b2bc3f73a0d56ee8f5ba732200" ON "leads" ("status", "created_at") `,
    );
    ...
    await queryRunner.query(`CREATE INDEX "IDX_d9d02e1c6a8746af7b565df55c" ON "deals" ("stage") `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "IDX_d9d02e1c6a8746af7b565df55c"`);
    await queryRunner.query(`DROP TABLE "deals"`);
    await queryRunner.query(`DROP TYPE "deals_stage_enum"`);
    await queryRunner.query(`DROP INDEX "IDX_5770b28d72ca90c43b1381bf78"`);
    ...
    await queryRunner.query(`DROP INDEX "IDX_b2bc3f73a0d56ee8f5ba732200"`);
    await queryRunner.query(`DROP INDEX "IDX_5c37aa54e3b06f6733d56007e0"`);
