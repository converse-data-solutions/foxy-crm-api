...
export class Coreapp1759733663525 implements MigrationInterface {
  name = 'Coreapp1759733663525';

  public async up(queryRunner: QueryRunner): Promise<void> {
    const schema: string = (queryRunner.connection.options as any).schema || 'public';
    await queryRunner.query(`SET search_path TO "${schema}",public`);
    await queryRunner.query(
      `CREATE TABLE "accounts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(40) NOT NULL, "industry" character varying(40) NOT NULL, "website" text NOT NULL, "address" character varying(50), "city" character varying(40), "country" character varying(50), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" uuid, CONSTRAINT "UQ_2db43cdbf7bb862e577b5f540c8" UNIQUE ("name"), CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "lead_activities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "activity_type" "lead_activities_activity_type_enum" NOT NULL, "activity_date" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "lead_id" uuid, "notes" uuid, "created_by" uuid, CONSTRAINT "PK_1aa1cc6988a817368568ca26bf1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "lead_activities" ADD CONSTRAINT "FK_a51cb3310bb8700495a08ec230d" FOREIGN KEY ("notes") REFERENCES "notes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "lead_activities" DROP CONSTRAINT "FK_a51cb3310bb8700495a08ec230d"`,
    );
    await queryRunner.query(
