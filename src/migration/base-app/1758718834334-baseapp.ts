...
export class Baseapp1758718834334 implements MigrationInterface {
  name = 'Baseapp1758718834334';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "subscriptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "plan_name" character varying(20) NOT NULL, "price" integer NOT NULL, "price_id" character varying(50) NOT NULL, "valid_upto" character varying(20) NOT NULL, CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tenant_subscriptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" boolean NOT NULL DEFAULT false, "start_date" TIMESTAMP, "end_date" TIMESTAMP, "stripe_session_id" character varying(100), "stripe_subscription_id" character varying(50), "stripe_customer_id" character varying(50), "tenant_id" uuid, "subscription_id" uuid, CONSTRAINT "REL_c59c97d5c1343951e044c137f0" UNIQUE ("tenant_id"), CONSTRAINT "PK_9455f2b3b10365e81538a079da3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tenant_subscriptions" DROP CONSTRAINT "FK_24e83935ee39de08328e16029c4"`,
    );
    await queryRunner.query(
