...
export class Coreapp1758203609337 implements MigrationInterface {
  name = 'Coreapp1758203609337';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "accounts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(30) NOT NULL, "industry" character varying(20) NOT NULL, "website" text NOT NULL, "address" character varying(50), "city" character varying(20), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "country_id" uuid, "created_by" uuid, CONSTRAINT "UQ_2db43cdbf7bb862e577b5f540c8" UNIQUE ("name"), CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(30) NOT NULL, "email" character varying(50) NOT NULL, "phone" character varying(20) NOT NULL, "password" character varying(100) NOT NULL, "role" "users_role_enum" NOT NULL DEFAULT 'salesrep', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "country_id" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_a000cca60bcf04454e727699490" UNIQUE ("phone"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "tasks_entity_name_enum" AS ENUM('opportunity', 'ticket')`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "oppurtunities_stage_enum" AS ENUM('qualified', 'proposal', 'negotiation', 'accepted', 'declined')`,
    );
    await queryRunner.query(
      `CREATE TABLE "oppurtunities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(30) NOT NULL, "value" integer NOT NULL, "stage" "oppurtunities_stage_enum" NOT NULL DEFAULT 'qualified', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "contact_id" uuid, CONSTRAINT "PK_5594809f56a5d35071cdb4cc329" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "oppurtunities" ADD CONSTRAINT "FK_c293c6f9854327478b753228b1c" FOREIGN KEY ("contact_id") REFERENCES "contacts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`SET search_path TO "${schema}",public`);
    await queryRunner.query(
      `ALTER TABLE "oppurtunities" DROP CONSTRAINT "FK_c293c6f9854327478b753228b1c"`,
    );
    ...
    await queryRunner.query(`DROP TABLE "oppurtunities"`);
    await queryRunner.query(`DROP TYPE "oppurtunities_stage_enum"`);
